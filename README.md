...
১.Interface keyword হিসেবে ব্যবহার করে interface,type keyword হিসেবে ব্যবহার করে type.
২. Interface অন্য interface কে extend keyword এর মাধ্যমে extend করতে পারে, Type extent keyword ব্যবহার করতে পারেনা।
৩.একই নামে দুই বার interface লিখলে তারা merge হয়ে যায় কিন্তু একই নামে দুইবার type লিখলে error দেয়।
৪.interface, Union type ব্যবহার করেনা,type Union type ব্যবহার করে।

# 2What is the use of the keyof keyword in TypeScript? Provide an example.
...
// console.log(getProperty(person1, "country")); // error
এখানে keyof ব্যবহার করে আমরা শুধু name, age ও city key গুলোই access করতে পারছি। যদি অন্য কোনো key দেওয়া হয়, TypeScript error দিবে।
